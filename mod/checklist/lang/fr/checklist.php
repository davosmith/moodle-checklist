...
$string['confirmdeleteitem'] = 'Etes-vous s�r de vouloir effacer d&eacute;finitivement cet item de la Liste des t&acirc;ches?';
...
Un administrateur peut contr&ocirc;ler qui re�oit ce courriel en utilisant la capacit&eacute; "mod: check-list / emailoncomplete" - par d&eacute;faut, tous les enseignants et non enseignants non &eacute;diteur ont cette capacit&eacute;.';
