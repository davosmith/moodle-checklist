...
2. Upload the files to the your moodle server, placing the 'mod/checklist' files in the '[moodlefolder]/mod/checklist' and (optionally) the 'blocks/checklist' files in the '[moodlefolder]/blocks/checklist' folder.
